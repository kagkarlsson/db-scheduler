...
public class TestHelper {
    ...
    public static class ManualSchedulerBuilder extends Scheduler.Builder {
        ...
        public ManualScheduler build() {
            ...
            return new ManualScheduler(clock, taskRepository, taskResolver, executorThreads, new DirectExecutorService(), schedulerName, waiter, heartbeatInterval, enableImmediateExecution, pollAfterCompletion, statsRegistry, startTasks);
        }
