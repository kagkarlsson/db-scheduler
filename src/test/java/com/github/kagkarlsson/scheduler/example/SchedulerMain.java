...
import com.github.kagkarlsson.scheduler.MssqlTestDatabaseRule;
...
public class SchedulerMain {
    ...
    public static void main(String[] args) throws Throwable {
        try {
            ...
            final MssqlTestDatabaseRule mssqlRule = new MssqlTestDatabaseRule();
            mssqlRule.before();
            final DataSource dataSource = mssqlRule.getDataSource();
