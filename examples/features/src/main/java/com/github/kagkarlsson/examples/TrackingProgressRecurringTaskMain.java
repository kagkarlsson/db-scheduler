...
public class TrackingProgressRecurringTaskMain extends Example {
  ...
  public void run(DataSource dataSource) {
    ...
    final RecurringTask<Counter> statefulTask =
        Tasks.recurring("counting-task", schedule, Counter.class)
                ...
                (taskInstance, executionContext) -> {
                  ...
                  return new Counter(
                      startingCounter.value
                          + 10); // new value to be persisted as task_data for the next run
                });
