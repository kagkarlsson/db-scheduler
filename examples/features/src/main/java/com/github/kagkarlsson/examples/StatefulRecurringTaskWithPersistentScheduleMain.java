...
public class StatefulRecurringTaskWithPersistentScheduleMain extends Example {
    ...
    public void run(DataSource dataSource) {
        ...
        final RecurringTaskWithPersistentSchedule<ScheduleAndInteger> task = Tasks.recurringWithPersistentSchedule(
                        "dynamic-recurring-task", ScheduleAndInteger.class)
        ...
        final Scheduler scheduler = Scheduler.create(dataSource, task)
