...
public class RecurringTaskTest {
    ...
    public void should_update_preexisting_exeutions_with_new_schedule_if_new_next_execution_time_before_preexisting() {
        ...
        RecurringTask<Void> recurringTaskNewSchedule = Tasks.recurring(
                        RECURRING_A, Schedules.daily(LocalTime.of(12, 0), LocalTime.of(23, 59)))
                .execute(TestTasks.DO_NOTHING);
    ...
    public void
        ...
        RecurringTask<Void> recurringTaskNewSchedule = Tasks.recurring(
                        RECURRING_A, Schedules.daily(LocalTime.of(23, 59)))
                .execute(TestTasks.DO_NOTHING);
    ...
    public void should_not_update_data_of_preexisting_exeutions_even_if_rescheduling_because_of_updated_schedule() {
        RecurringTask<Integer> recurringTask = Tasks.recurring(
                        RECURRING_A, Schedules.daily(LocalTime.of(23, 59)), Integer.class)
                .initialData(1)
        ...
        // Add an additional execution-time to the daily schedule
        RecurringTask<Integer> recurringTaskNewSchedule = Tasks.recurring(
                        RECURRING_A, Schedules.daily(LocalTime.of(12, 0), LocalTime.of(23, 59)), Integer.class)
                .initialData(2)
                .execute((taskInstance, executionContext) -> {});
    ...
    private void assertScheduled(
            ManualScheduler scheduler, String taskName, LocalTime expectedExecutionTime, Object taskData) {
