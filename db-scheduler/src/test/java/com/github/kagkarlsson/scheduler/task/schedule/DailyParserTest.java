...
public class DailyParserTest {
    private static final LocalTime HOUR_9_30 = LocalTime.of(9, 30);
    private static final LocalTime HOUR_16_30 = LocalTime.of(16, 30);
    private static final LocalTime HOUR_18_30 = LocalTime.of(18, 30);
    private static final LocalTime HOUR_20_30 = LocalTime.of(20, 30);
    ...
    public void should_recognize_correct_schedule_string_without_timezone() {
        ...
        assertEquals(
                Optional.of(new Daily(HOUR_9_30, HOUR_16_30, HOUR_18_30)), parser.parse("DAILY|09:30,16:30,18:30"));
        assertEquals(
                Optional.of(new Daily(HOUR_9_30, HOUR_16_30, HOUR_18_30, HOUR_20_30)),
    ...
    public void should_recognize_correct_schedule_with_timezone_string() {
        ...
        assertEquals(
                Optional.of(new Daily(ROME, HOUR_9_30, HOUR_16_30)), parser.parse("DAILY|09:30,16:30|Europe/Rome"));
        assertEquals(
                Optional.of(new Daily(ROME, HOUR_9_30, HOUR_16_30, HOUR_18_30)),
                parser.parse("DAILY|09:30,16:30,18:30|Europe/Rome"));
        assertEquals(
                Optional.of(new Daily(ROME, HOUR_9_30, HOUR_16_30, HOUR_18_30, HOUR_20_30)),
