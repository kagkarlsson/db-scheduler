...
public class ExecutorPoolTest {
    ...
    private void testExecuteUntilNoneLeft(int pollingLimit, int threads, int executionsToRun) {
        ...
        TestableRegistry registry =
                TestableRegistry.create().waitConditions(condition).build();
    ...
    private String waitingForConditionTimedOut(Scheduler scheduler) {
        ...
        scheduler.fetchScheduledExecutions(se -> scheduled.add(
                se.getTaskInstance().getTaskName() + "_" + se.getTaskInstance().getId()));
