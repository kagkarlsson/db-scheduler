...
public class SchedulerTest {
	...
	private Scheduler schedulerFor(ExecutorService executor, Task<?> ... tasks) {
		...
		return new Scheduler(clock, taskRepository, taskResolver, 1, executor, new SchedulerName.Fixed("name"), new Waiter(Duration.ZERO), Duration.ofSeconds(1), false, statsRegistry, 10_000, new ArrayList<>());
	}
