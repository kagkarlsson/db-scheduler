...
public class DailyTest {
    ...
    public void should_generate_next_date_correctly() {
        ...
        assertThat(new Daily(HOUR_8).getNextExecutionTime(complete(instant(currentDate, HOUR_0))),
                is(instant(currentDate, HOUR_8)));
        assertThat(new Daily(HOUR_8).getNextExecutionTime(complete(instant(currentDate, HOUR_8))),
                is(instant(nextDay, HOUR_8)));

        assertThat(new Daily(HOUR_8, HOUR_12).getNextExecutionTime(complete(instant(currentDate, HOUR_0))),
                is(instant(currentDate, HOUR_8)));
        assertThat(new Daily(HOUR_8, HOUR_12).getNextExecutionTime(complete(instant(currentDate, HOUR_8))),
                is(instant(currentDate, HOUR_12)));
        assertThat(new Daily(HOUR_8, HOUR_12).getNextExecutionTime(complete(instant(currentDate, HOUR_12))),
                is(instant(nextDay, HOUR_8)));
        // order should be irrelevant
        assertThat(new Daily(HOUR_12, HOUR_8).getNextExecutionTime(complete(instant(currentDate, HOUR_0))),
                is(instant(currentDate, HOUR_8)));
    }
    ...
    public void should_generate_next_date_correctly_during_standard_time() {
        ...
        assertThat(new Daily(ROME, HOUR_8).getNextExecutionTime(complete(instant(currentDate, HOUR_0, UTC))),
                is(instant(currentDate, HOUR_7, UTC)));
        assertThat(new Daily(ROME, HOUR_8).getNextExecutionTime(complete(instant(currentDate, HOUR_7, UTC))),
    ...
    public void should_generate_next_date_correctly_during_daylight_saving_time() {
        ...
        assertThat(new Daily(ROME, HOUR_8).getNextExecutionTime(complete(instant(currentDate, HOUR_6, UTC))),
    ...
    public void should_generate_next_date_correctly_on_the_day_when_time_changes_to_daylight_saving() {
        ...
        assertThat(new Daily(ROME, HOUR_2).getNextExecutionTime(complete(instant(currentDate, HOUR_0, UTC))),
                is(instant(currentDate, HOUR_1, UTC)));
        assertThat(new Daily(ROME, HOUR_3).getNextExecutionTime(complete(instant(currentDate, HOUR_0, UTC))),
                is(instant(currentDate, HOUR_1, UTC)));
    }
    ...
    public void should_generate_next_date_correctly_on_the_day_when_time_changes_to_standard() {
        ...
        assertThat(new Daily(ROME, HOUR_2).getNextExecutionTime(complete(instant(previousDay, HOUR_23, UTC))),
    ...
    public void to_string() {
        assertEquals("Daily times=[01:00, 02:00], zone=Europe/Rome",
