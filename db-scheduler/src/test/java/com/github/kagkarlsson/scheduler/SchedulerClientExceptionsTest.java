...
public class SchedulerClientExceptionsTest {
  ...
  public void failsToRescheduleWhenTaskIsNotFound() {
    ...
    TaskInstanceNotFoundException actualException =
        assertThrows(
            TaskInstanceNotFoundException.class,
            () -> {
              schedulerClient.reschedule(taskInstance, Instant.now(), null);
            });
    assertEquals(
        "Failed to perform action on task because it was not found. (task name: "
  ...
  public void failsToRescheduleWhenATaskIsPickedAndExecuting() {
    ...
    TaskInstanceCurrentlyExecutingException actualException =
        assertThrows(
