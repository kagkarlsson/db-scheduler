...
public class ExecutionTest {
    ...
    public void test_equals() {
        ...
        RecurringTask<Void> task2 = TestTasks.recurring("Recurring", FixedDelay.of(Duration.ofHours(1)),
                TestTasks.DO_NOTHING);

        assertEquals(new Execution(now, task.instance("id1")), new Execution(now, task.instance("id1")));
        assertNotEquals(new Execution(now, task.instance("id1")),
        ...
        assertNotEquals(new Execution(now, task2.instance("id1")),
