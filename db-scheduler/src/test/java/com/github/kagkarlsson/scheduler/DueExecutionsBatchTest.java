...
public class DueExecutionsBatchTest {
    ...
    public void test_trigger_check_for_more_due() {
        ...
        assertTrigger(1, HAPPY_NUMBER_ADDED_LAST_TIME,
    ...
    private DueExecutionsBatch newBatch(int schedulerThreadpoolSize, int numberAddedFromLastDbQuery,
            boolean likelyMoreDueInDb) {
        DueExecutionsBatch batch = new DueExecutionsBatch(HAPPY_GENERATION_NUMBER, numberAddedFromLastDbQuery,
                likelyMoreDueInDb, leftInBatch -> leftInBatch <= schedulerThreadpoolSize
