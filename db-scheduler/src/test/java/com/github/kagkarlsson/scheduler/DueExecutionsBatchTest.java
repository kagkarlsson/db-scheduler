...
public class DueExecutionsBatchTest {
    ...
    public void test_trigger_check_for_more_due() {
        ...
        assertTrigger(
                0, HAPPY_NUMBER_ADDED_LAST_TIME, newBatch(HAPPY_THREADPOOL_SIZE, HAPPY_NUMBER_ADDED_LAST_TIME, false));
    ...
    private DueExecutionsBatch newBatch(
        ...
        DueExecutionsBatch batch = new DueExecutionsBatch(
                HAPPY_GENERATION_NUMBER,
                numberAddedFromLastDbQuery,
                likelyMoreDueInDb,
                leftInBatch -> leftInBatch
                        <= schedulerThreadpoolSize * Scheduler.TRIGGER_NEXT_BATCH_WHEN_AVAILABLE_THREADS_RATIO);
        return batch;
    }
