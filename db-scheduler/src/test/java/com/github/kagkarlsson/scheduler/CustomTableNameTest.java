...
public class CustomTableNameTest {
    ...
    public void setUp() {
        ...
        taskRepository = new JdbcTaskRepository(DB.getDataSource(), false, CUSTOM_TABLENAME,
                new TaskResolver(StatsRegistry.NOOP, knownTasks), new SchedulerName.Fixed(SCHEDULER_NAME),
                new SystemClock());
    ...
    public void can_customize_table_name() {
        ...
        jdbcRunner.query("SELECT count(1) AS number_of_tasks FROM " + CUSTOM_TABLENAME, NOOP,
