...
public class DynamicRecurringTaskTest {
    ...
    public void should_schedule_multiple_instances_with_different_schedules() {
        ...
        final RecurringTaskWithPersistentSchedule<PlainScheduleAndData> task = Tasks.recurringWithPersistentSchedule(
                        taskName, PlainScheduleAndData.class)
    ...
    private void assertScheduled(
            ManualScheduler scheduler, TaskInstanceId instanceId, LocalTime expectedExecutionTime, Object taskData) {
        assertScheduled(
                scheduler,
                instanceId,
    ...
    private void assertScheduled(
            ManualScheduler scheduler, TaskInstanceId instanceId, Instant expectedExecutionTime, Object taskData) {
