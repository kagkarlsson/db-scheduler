...
public class PollingStrategyConfig {
    ...
    public static final PollingStrategyConfig DEFAULT =
        new PollingStrategyConfig(
            Type.FETCH_DUE_EXECUTIONS_THEN_LOCK_BEFORE_EXECUTING,
            0.5, 3.0);

    public static final PollingStrategyConfig DEFAULT_SELECT_FOR_UPDATE =
        new PollingStrategyConfig(
            Type.FETCH_PRELOCKED_EXECUTIONS_USING_SELECT_FOR_UPDATE,
            0.5, 1.0);
    ...
    public enum Type {
        FETCH_DUE_EXECUTIONS_THEN_LOCK_BEFORE_EXECUTING,
        FETCH_PRELOCKED_EXECUTIONS_USING_SELECT_FOR_UPDATE,
    }
