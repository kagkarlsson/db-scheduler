...
public class CompositeSchedulerListener implements SchedulerListener {
  private static final Logger LOG = LoggerFactory.getLogger(CompositeSchedulerListener.class);

  private final List<SchedulerListener> schedulerListeners;

  public CompositeSchedulerListener(List<SchedulerListener> schedulerListeners) {
